...
$manifestPath = Join-Path $selfContainedRoot 'native-composition-webview-poc.manifest'
...
$executable = Join-Path $distRoot 'native-composition-webview-poc.exe'
Copy-Item -LiteralPath (Join-Path $cargoTarget 'debug\native-composition-webview-poc.exe') -Destination $executable -Force
